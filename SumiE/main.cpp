...
float avg_color_alpha_threshold = 1.0f;
...
void display() {
	...
	int avg_color_alpha_threshold_location = glGetUniformLocation(reflection_program_id, "avg_color_alpha_threshold");
	int alpha_skip_threshold_location = glGetUniformLocation(reflection_program_id, "alpha_skip_threshold");
	// Using Program
	...
	glUniform1f(reflection_locations.avg_color_alpha_threshold_location, avg_color_alpha_threshold);
	glUniform1f(reflection_locations.alpha_skip_threshold_location, alpha_skip_threshold);
	// Draw tweakbar
	TwDraw();
	// Swap Buffers
    glutSwapBuffers();
